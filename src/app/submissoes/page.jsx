        ...
        <main className="mx-auto">
            ...
            <div className="w-full space-y-5 text-pallete-white px-4 md:px-16 xl:px-28 2xl:px-64 pb-10 flex flex-wrap flex-col content-start ">
                ...
                <div className="grid md:grid-cols-6 items-center gap-x-4">
                    ...
                    <BodyText>Todos os trabalhos aprovados pelo comitê científico serão publicados nos anais, desde que pelo menos um autor esteja regularmente inscrito e realizado o pagamento da taxa de artigos"</BodyText>
